...
const pillars = [
  ...
  { icon: BookOpen, label: "Education", color: "text-navy" },
  { icon: Brain, label: "Mental Health", color: "text-olive" },
  { icon: Shield, label: "Protection", color: "text-primary" },
  { icon: Sprout, label: "Growth", color: "text-olive" },
  { icon: TrendingUp, label: "Empowerment", color: "text-navy" },
];
      ...
      <div className="container mx-auto text-center">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            ...
            <span className="text-navy italic">collective</span> action.
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg leading-relaxed mb-12">
            Our mission is to uplift underserved communities by providing vital resources, education, and support — creating pathways to a healthier, more equitable future.
          </p>
        </motion.div>
